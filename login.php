...
$sql="select email from user_info where email='$username' and pwd='$password'";

//$sql="Select * from user_info where name='$username' and pwd='$password'" ; 

//fire query over user table 
